"""System prompt de Humanizacion.

Copia exacta del bloque en docs/aw1s/prompts/humanizacion.md. Si se edita
el prompt, actualizar los dos lugares -mismo criterio que
inteligencia/prompt.py.
"""
